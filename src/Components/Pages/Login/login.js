  ...
  return (
    <>
      ...
      <div className="h-screen bg-Background_gradint flex items-center justify-center w-full relative overflow-hidden">
        <div className="grid grid-cols-2 items-center w-100 h-full">
          <div className="h-full flex items-center justify-center">
            <img src={LoginIllustation} alt="" className="w-1/2 object-fill" />
          </div>
          <div className="flex items-center justify-center bg-Background_login h-full">
