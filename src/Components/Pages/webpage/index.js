      ...
      <div className="bg-Mainbackground_gradint">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 xl:items-center items-start justify-between flex-wrap">
              <div className="">
                ...
                <div className="flex items-center gap-4 mt-[28px] flex-wrap lg:justify-start justify-center">
                  ...
                  <button className="w-[324px] h-[80px] px-2 bg-red text-[28px] text-white rounded-full flex items-center justify-center gap-[14px]">
                    Download the app{" "}
        ...
        <div className="BottomShape mt-24 pt-[111px] pb-[190px] relative">
          <div className="xl:max-w-[80%] mx-auto px-3">
            <div>
              <h2 className="lg:text-left text-center lg:text-[50px] text-[45px] font-semibold text-white">
                Your happily
                <span className="uppercase ml-2 lg:static block">
                  ever after
                </span>
              </h2>
              <h2 className="lg:text-end text-center lg:text-[68px] text-[47px] font-semibold text-white uppercase lg:max-w-[556px] relative">
                Talkangel!
              </h2>
